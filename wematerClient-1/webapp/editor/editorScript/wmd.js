...
Attacklab.wmdBase = function(){
	...
	//update here
	global.isChrome    = /chrome/.test(nav.userAgent.toLocaleString());
	...
	var linkDialogText = "<p style='margin-top: -55px; color:#f1f1f1;'><b>Enter the web address.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />http://www.wemtar.org/   \"Optional title\"</p>";
	...
	util.prompt = function(text, defaultInputText, makeLinkMarkdown){
		...
		var createDialog = function(){
			...
			okButton.className = "button-a blue-button";
			...
			cancelButton.className = "button-a blue-button";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			var boldSpan =  document.createElement("i");
			boldSpan.className = "fa " + "fa-bold";
			boldButton.appendChild(boldSpan);
			...
			var italicSpan =  document.createElement("i");
			italicSpan.className = "fa " + "fa-italic";
			italicButton.appendChild(italicSpan);
			...
			var quoteSpan =  document.createElement("i");
			quoteSpan.className = "fa " + "fa-quote-left";
			quoteButton.appendChild(quoteSpan);
			...
			var codeSpan =  document.createElement("i");
			codeSpan.className = "fa " + "fa-code";
			codeButton.appendChild(codeSpan);
			...
			/*
			 * block the button for image coz we force user to upload image later after finishing the article
...
*/
			...
			var olistSpan =  document.createElement("i");
			olistSpan.className = "fa " + "fa-list-ol";
			olistButton.appendChild(olistSpan);
			...
			var ulistSpan =  document.createElement("i");
			ulistSpan.className = "fa " + "fa-list-ul";
			ulistButton.appendChild(ulistSpan);
			...
			var headingSpan =  document.createElement("i");
			headingSpan.className = "fa " + "fa-header";
			...
			var hrSpan =  document.createElement("i");
			hrSpan.className = "fa " + "fa-arrows-h";
			hrButton.appendChild(hrSpan);
			...
			var undoSpan =  document.createElement("i");
			undoSpan.className = "fa " + "fa-undo";
			...
			var redoSpan =  document.createElement("i");
			redoSpan.className = "fa " + "fa-repeat";
			redoButton.appendChild(redoSpan);
			...
			var helpSpan =  document.createElement("i");
			helpSpan.className = "fa " + "fa-info";
			helpButton.appendChild(helpSpan);
